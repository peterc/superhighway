...
The key advantage of oklch? Many feel that lightness steps from one shade to another feel *visually* even. Chroma across all four palettes peaks around 0.031–0.034 — barely above zero — which is what keeps them firmly in neutral territory despite having a distinct hue. Will you be using them?

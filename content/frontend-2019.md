---
title: "The top Frontend links of 2019"
description: "Highlights from the past twelve months in the browser, CSS, HTML and web space."
date: 2019-12-18
...
*As a quick aside, the data used to compile this list comes [via Frontend Focus](https://frontendfoc.us "Frontend Newsletter"), an email newsletter with over 90,000 developers reading it. This list represents some of the most clicked articles of the year.*
...
Back in March the W3C shared news that the Web Authentication API (WebAuthn) had become an official web standard for password-free logins on the web. Since then support for the security-focused standard has been growing, with browsers such as [Safari](https://www.macrumors.com/2019/11/21/apple-releases-safari-technology-preview-96/) and [Firefox](https://blog.mozilla.org/security/2019/08/05/web-authentication-in-firefox-for-android/), and big names like [Twitter](https://www.trustedreviews.com/news/twitter-brings-webauthn-two-factor-authentication-help-protect-accounts-3956937) and [eBay](https://www.cbronline.com/news/ebay-webauthn) adding support.
...
Emma Wedekind took a quick look at a handful of HTML elements you might not have known existed. These include the `<output>`, `<meter>`, and `<progress>` tags to name just a few.

------------------------------------------------------------------------

**[The Great Divide in Front-End Development Skills](https://css-tricks.com/the-great-divide/)**
...
**[HTML5's Input Types: Where Are They Now?](https://www.smashingmagazine.com/2019/01/html5-input-types/)**
